...
GO
PRINT N'Выполняется создание [dbo].[FK_GameHistory_Player1]...';


GO
ALTER TABLE [dbo].[GameHistory]
    ADD CONSTRAINT [FK_GameHistory_Player1] FOREIGN KEY ([WhitePlayerId]) REFERENCES [dbo].[Player] ([Id]);


GO
PRINT N'Выполняется создание [dbo].[FK_GameHistory_Player2]...';


GO
ALTER TABLE [dbo].[GameHistory]
    ADD CONSTRAINT [FK_GameHistory_Player2] FOREIGN KEY ([BlackPlayerId]) REFERENCES [dbo].[Player] ([Id]);


GO
PRINT N'Выполняется создание [dbo].[FK_GameHistory_Winner]...';


GO
ALTER TABLE [dbo].[GameHistory]
    ADD CONSTRAINT [FK_GameHistory_Winner] FOREIGN KEY ([WinnerId]) REFERENCES [dbo].[Player] ([Id]);


GO
PRINT N'Выполняется создание [dbo].[FK_GameHistory_EndGameType]...';


GO
ALTER TABLE [dbo].[GameHistory]
    ADD CONSTRAINT [FK_GameHistory_EndGameType] FOREIGN KEY ([EndGameTypeId]) REFERENCES [dbo].[EndGameType] ([Id]);


GO
PRINT N'Выполняется создание [dbo].[FK_GameHistory_GameType]...';


GO
ALTER TABLE [dbo].[GameHistory]
    ADD CONSTRAINT [FK_GameHistory_GameType] FOREIGN KEY ([GameTypeId]) REFERENCES [dbo].[GameType] ([Id]);


GO
PRINT N'Выполняется создание [dbo].[FK_Player_PlayerDetails]...';


GO
ALTER TABLE [dbo].[Player]
    ADD CONSTRAINT [FK_Player_PlayerDetails] FOREIGN KEY ([PlayerDetailsId]) REFERENCES [dbo].[PlayerDetails] ([Id]);


GO
PRINT N'Выполняется создание [dbo].[FK_Player_Status]...';


GO
ALTER TABLE [dbo].[Player]
    ADD CONSTRAINT [FK_Player_Status] FOREIGN KEY ([StatusId]) REFERENCES [dbo].[Status] ([Id]);


GO
PRINT N'Выполняется создание [dbo].[FK_Player_Role]...';


GO
ALTER TABLE [dbo].[Player]
    ADD CONSTRAINT [FK_Player_Role] FOREIGN KEY ([RoleId]) REFERENCES [dbo].[Role] ([Id]);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '136a4353-3ee2-4a2d-b55d-d9a0ae35eb62')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('136a4353-3ee2-4a2d-b55d-d9a0ae35eb62')
...
VALUES 
(N'18f63087-80fa-45ba-1623-000170c900b0')
